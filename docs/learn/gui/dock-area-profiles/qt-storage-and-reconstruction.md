...
- widget state saved from [Qt properties](https://doc.qt.io/qtforpython-6/PySide6/QtCore/Property.html)
- profile metadata such as timestamps and quick-selection state
- an optional screenshot preview

The dock layout itself is written through [QSettings](https://doc.qt.io/qtforpython-6/PySide6/QtCore/QSettings.html), together with
...
settings are exposed as [Qt properties](https://doc.qt.io/qtforpython-6/PySide6/QtCore/Property.html) and are not explicitly skipped by the widget state manager.
