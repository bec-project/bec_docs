...
For comprehensive instructions on how to manage profiles, including sharing, switching, deleting and restoring them, see
the [Dock Area Profiles how-to guides](../../how-to/gui/dock-area-profiles.md){ data-preview }.
The more in-depth explanation can be found in [Dock Area Profiles](../../learn/gui/dock-area-profiles/index.md){ data-preview }.
